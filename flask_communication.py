...
from mongodb.cache_sudoku_boards import cache_sudoku_board
            ...
            if validate_rect(coords):
                ...
                if not validation:
                    ...
                    if (collection.find_one(query) != None):
                        ...
                        print("Sudoku board found in MongoDB cache")
                        solved_grid_image = collection.find_one(query)["solution"]
                        found = True
